    ...
    return(
        <div className="col-12 col-md-4 col-lg-3 mb-1 h-100 my-4">
            <div className="card-body shadow">
                ...
                {movie.genero ? (<p className="card-text">Género: {movie.genero.name}</p>) : null}
            ...
            <div className="modal fade" id={`exampleModal${movie.id}`} tabIndex="-1" aria-labelledby={`exampleModalLable${movie.id}`} aria-hidden="true">

            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id={`exampleModalLable${movie.id}`}>¿ESTÁS SEGUR@ QUE QUERÉS ELIMINAR?</h5>
